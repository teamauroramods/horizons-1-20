...
public class HorizonsTreePlacements {
    ...
    public static final ResourceKey<PlacedFeature> MEGA_CYPRESS_KNEES_CHECKED = key("mega_cypress_knees_checked");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        Holder<ConfiguredFeature<?, ?>> megaCypressKnees = configuredFeatures.getOrThrow(HorizonsTreeFeatures.MEGA_CYPRESS_KNEES);
