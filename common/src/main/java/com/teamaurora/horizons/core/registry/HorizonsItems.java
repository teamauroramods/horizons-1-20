...
public final class HorizonsItems {
    ...
    public static final Pair<RegistryReference<Item>, RegistryReference<Item>> JACARANDA_BOATS = PROVIDER.registerBoats("jacaranda", HorizonsBlocks.JACARANDA_PLANKS);
