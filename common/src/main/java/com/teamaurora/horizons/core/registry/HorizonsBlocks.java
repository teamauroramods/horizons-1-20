...
public class HorizonsBlocks {
    ...
    public static final Pair<RegistryReference<BorealibCeilingHangingSignBlock>, RegistryReference<BorealibWallHangingSignBlock>> CYPRESS_HANGING_SIGNS = PROVIDER.registerHangingSign("cypress", HorizonsWoodTypes.CYPRESS, )
