...
public class HorizonsModelProvider extends BorealibModelProvider {
    ...
    public void generateBlockModels(BlockModelGenerators generator) {
        ...
        // Algae Thatch //
        createThatchFamilyExceptStairs(generator, ALGAE_THATCH_FAMILY);
    ...
    public void generateItemModels(ItemModelGenerators generator) {
        createWoodItems(generator, CYPRESS_BOATS, CYPRESS_HANGING_SIGNS);
    }
    ...
    private static void createWoodItems(ItemModelGenerators generator, Pair<RegistryReference<Item>, RegistryReference<Item>> boats, Pair<RegistryReference<BorealibCeilingHangingSignBlock>, RegistryReference<BorealibWallHangingSignBlock>> hangingSigns) {
    ...
    private static void createThatchFamilyExceptStairs(BlockModelGenerators generator, BlockFamily family) {
