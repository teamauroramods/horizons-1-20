...
public final class HorizonsFeatures {
    ...
    public static final RegistryReference<LavenderFeature> LAVENDER = PROVIDER.register("lavender", ()-> new LavenderFeature(NoneFeatureConfiguration.CODEC));
    //public static final RegistryReference<JacarandaFeature> JACARANDA_TREE = PROVIDER.register("jacaranda_tree", () -> new JacarandaFeature(TreeConfiguration.CODEC));
}
