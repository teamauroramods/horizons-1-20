...
public class HorizonsBlockTagsProvider extends BorealibTagsProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_CYPRESS_SAPLING.get(), POTTED_BLUE_LILY.get(), POTTED_LIGHT_GRAY_LILY.get(), POTTED_CYAN_LILY.get(), POTTED_LIGHT_BLUE_LILY.get(), POTTED_MAGENTA_LILY.get(), POTTED_PINK_LILY.get(), POTTED_PURPLE_LILY.get(), POTTED_WHITE_LILY.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(BLUE_LILY.get(), LIGHT_GRAY_LILY.get(), CYAN_LILY.get(), LIGHT_BLUE_LILY.get(), MAGENTA_LILY.get(), PINK_LILY.get(), PURPLE_LILY.get(), WHITE_LILY.get());
        ...
        //this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(LIGHT_BOULDER.get(), LIGHT_BOULDER_SLAB.get(), LIGHT_BOULDER_STAIRS.get(), LIGHT_BOULDER_VERTICAL_SLAB.get(), LIGHT_BOULDER_WALL.get(), MOSSY_LIGHT_BOULDER.get(), MOSSY_LIGHT_BOULDER_SLAB.get(), MOSSY_LIGHT_BOULDER_STAIRS.get(), MOSSY_LIGHT_BOULDER_VERTICAL_SLAB.get(), MOSSY_LIGHT_BOULDER_WALL.get(), DARK_BOULDER.get(), DARK_BOULDER_SLAB.get(), DARK_BOULDER_STAIRS.get(), DARK_BOULDER_VERTICAL_SLAB.get(), DARK_BOULDER_WALL.get(), MOSSY_DARK_BOULDER.get(), MOSSY_DARK_BOULDER_SLAB.get(), MOSSY_DARK_BOULDER_STAIRS.get(), MOSSY_DARK_BOULDER_VERTICAL_SLAB.get(), MOSSY_DARK_BOULDER_WALL.get(), BOULDER_BRICKS.get(), BOULDER_BRICK_SLAB.get(), BOULDER_BRICK_STAIRS.get(), BOULDER_BRICK_VERTICAL_SLAB.get(), BOULDER_BRICK_WALL.get());
    }
