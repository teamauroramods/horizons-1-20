...
import static com.teamaurora.horizons.core.other.tags.HorizonsBlockTags.REDWOOD_LOGS;
...
public class HorizonsBlockTagsProvider extends BorealibTagsProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        this.tag(BlockTags.WOODEN_BUTTONS).add(CYPRESS_BUTTON.get(), REDWOOD_BUTTON.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(CYPRESS_PRESSURE_PLATE.get(), REDWOOD_PRESSURE_PLATE.get());
        this.tag(BlockTags.PLANKS).add(CYPRESS_PLANKS.get(), REDWOOD_PLANKS.get());
        this.tag(BlockTags.WOODEN_DOORS).add(CYPRESS_DOOR.get(), REDWOOD_DOOR.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(CYPRESS_TRAPDOOR.get(), REDWOOD_TRAPDOOR.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(CYPRESS_STAIRS.get(), REDWOOD_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(CYPRESS_SLAB.get(), REDWOOD_SLAB.get());
        this.tag(BlockTags.WALL_SIGNS).add(CYPRESS_SIGNS.getSecond().get(), REDWOOD_SIGNS.getSecond().get());
        this.tag(BlockTags.STANDING_SIGNS).add(CYPRESS_SIGNS.getFirst().get(), REDWOOD_SIGNS.getFirst().get());
        this.tag(BlockTags.CEILING_HANGING_SIGNS).add(CYPRESS_HANGING_SIGNS.getFirst().get(), REDWOOD_HANGING_SIGNS.getFirst().get());
        this.tag(BlockTags.WALL_HANGING_SIGNS).add(CYPRESS_HANGING_SIGNS.getSecond().get(), REDWOOD_HANGING_SIGNS.getSecond().get());
        this.tag(BlockTags.WOODEN_FENCES).add(CYPRESS_FENCE.get(), REDWOOD_FENCE.get());
        this.tag(BlockTags.LOGS_THAT_BURN).addTag(CYPRESS_LOGS).addTag(REDWOOD_LOGS);
        this.tag(BlockTags.LEAVES).add(CYPRESS_LEAVES.get(), REDWOOD_LEAVES.get());
        this.tag(BlockTags.CLIMBABLE).add(BEARD_MOSS.get());
        this.tag(BlockTags.FENCE_GATES).add(CYPRESS_FENCE_GATE.get(), REDWOOD_FENCE_GATE.get());
        this.tag(BlockTags.SAPLINGS).add(CYPRESS_SAPLING.get(), REDWOOD_SAPLING.get());
        this.tag(BlockTags.OVERWORLD_NATURAL_LOGS).add(CYPRESS_LOG.get(), REDWOOD_LOG.get());
        this.tag(BlockTags.GUARDED_BY_PIGLINS).add(CYPRESS_CHESTS.getFirst().get(), CYPRESS_CHESTS.getSecond().get(), REDWOOD_CHESTS.getFirst().get(), REDWOOD_CHESTS.getSecond().get());
        this.tag(BlockTags.TALL_FLOWERS).add(HELICONIA.get());
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_CYPRESS_SAPLING.get(), POTTED_BLUE_LILY.get(), POTTED_LIGHT_GRAY_LILY.get(), POTTED_CYAN_LILY.get(), POTTED_LIGHT_BLUE_LILY.get(), POTTED_MAGENTA_LILY.get(), POTTED_PINK_LILY.get(), POTTED_PURPLE_LILY.get(), POTTED_WHITE_LILY.get(), POTTED_FIDDLENECK.get(), POTTED_AMARANTHUS.get(), POTTED_MYOSOTIS.get(), POTTED_REDWOOD_SAPLING.get());
